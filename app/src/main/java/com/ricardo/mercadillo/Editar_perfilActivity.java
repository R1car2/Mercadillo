        ...
        if (uid != null) {
            ...
            ref.child(uid)
                    ...
                    .addOnSuccessListener(aVoid -> {
                        ...
                        Toast.makeText(Editar_perfilActivity.this, "Perfil actualizado exitosamente!", Toast.LENGTH_LONG).show();
                    })
                    .addOnFailureListener(e -> {
                        progressDialog.dismiss();
                        Toast.makeText(Editar_perfilActivity.this, "Error al actualizar: " + e.getMessage(), Toast.LENGTH_LONG).show();
